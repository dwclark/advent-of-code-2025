(defpackage :utils
  (:use :cl)
  (:export #:read-file #:read-day-file #:split-blank-lines #:read-blank-line-blocks #:day-file-path
           #:read-lists-of-symbols #:print-assert
           #:bit-vector->integer #:integer->bit-vector #:power-set #:range-overlap-p
           #:*to-add/8*))

(in-package :utils)

(defun day-file-path (day)
  (asdf:system-relative-pathname "advent-of-code-2025" (concatenate 'string "inputs/day-" day ".txt")))
